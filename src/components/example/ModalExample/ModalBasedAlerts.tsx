    ...
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="px-4 py-3 text-sm font-medium text-white rounded-lg bg-yellow-light-500 shadow-theme-xs hover:bg-yellow-light-600"
        >
          Info Alert
        </button>
        <button
      ...
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <svg
              className="fill-yellow-light-50 dark:fill-yellow-light-500/15"
              width="90"
              height="90"
              viewBox="0 0 90 90"
              fill="none"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
              <svg
                className="fill-yellow-light-500 dark:fill-yellow-light-500"
                width="38"
                height="38"
                viewBox="0 0 38 38"
                fill="none"
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-yellow-light-500 shadow-theme-xs hover:bg-yellow-light-600 sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
