...
export default function RecentOrders() {
  ...
  dark:border-brand-600 dark:bg-brand-500/[0.12] dark:text-brand-300 dark:hover:bg-brand-500/[0.2] dark:hover:text-brand-100"
          >
            <svg
              className="stroke-current fill-white dark:fill-brand-500"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
